var text = [ 
    ...
    ["Ну правильно, я же девушка. Это только у вас - парней в комнате непойми что. А я убираюсь часто и слежу за порядком.", "Кира", "khaki", "Sprites/Characters/Girl_0_1.png"],
    ],
    [
...
var delay = 50; // Скорость печатания
...
reset_sentence = function() {
    ...
    document.getElementById('character_portret').style.background ='url(' + text[level][sentence][3] +')';
    document.getElementById('character_portret').style.backgroundSize = 'auto 100vh';
    document.getElementById('character_portret').style.backgroundPosition= 'center';
    document.getElementById('character_portret').style.backgroundRepeat= 'no-repeat';
